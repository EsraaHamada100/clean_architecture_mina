import 'package:clean_archeticture/presentation/onboarding/view_model/on_boarding_view_model.dart';
...
import 'package:clean_archeticture/presentation/resources/constants.dart';
  ...
  Widget _getContentWidget(SliderViewObject? sliderViewObject) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // to make the color of the bar that has battery, wifi ....etc
        // have a white color
        systemOverlayStyle: SystemUiOverlayStyle(
          statusBarColor: ColorManager.white,
          // telling him to make the wifi, battery...etc icons dark
